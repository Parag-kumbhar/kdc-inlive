...
//           player brings unique skills, dedication, and passion to the game. We
//           celebrate their journeys, achievements, and the hard work that
//           defines local cricket excellence.
//         </p>

//         {/* Feature Cards */}
//         <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20">
//           {/* Card 1 */}
//           <div className="border border-blue-300 rounded-2xl p-8 relative">
//             <div className="absolute -top-6 left-6 w-12 h-12 rounded-full bg-blue-400 flex items-center justify-center text-white">
//               🏏
//             </div>
...
//               Comprehensive profiles featuring career statistics, batting and
//               bowling averages, match performances, and personal background
//               stories of standout district players.
//             </p>
//           </div>
...
//             </h3>
//             <p className="text-gray-700 leading-relaxed">
//               Curated collections of top performances, match-winning innings,
//               brilliant bowling spells, spectacular catches, and memorable
...
//             </h3>
//             <p className="text-gray-700 leading-relaxed">
//               Follow the remarkable paths from grassroots cricket to
//               district-level stardom, showcasing dedication, perseverance, and
//               the dreams that drive our local heroes.
//             </p>
//           </div>
//         </div>
