...
//           {/* 1 */}
//           <div className="border border-blue-300 rounded-2xl p-8
//                   transition-all duration-300 ease-out
//                   hover:-translate-y-2 hover:shadow-xl">
//             <div className="text-xl font-bold mb-4 text-gray-900">1</div>
...
//               Hit subscribe on our YouTube channel for live match alerts,
//               exclusive content, player interviews, and highlights delivered
...
//                   transition-all duration-300 ease-out
//                   hover:-translate-y-2 hover:shadow-xl">
//             <div className="text-xl font-bold mb-4 text-gray-900">2</div>
...
//                   transition-all duration-300 ease-out
//                   hover:-translate-y-2 hover:shadow-xl">
//             <div className="text-xl font-bold mb-4 text-gray-900">3</div>
...
//             <p className="text-gray-800 leading-relaxed">
//               Get the upcoming KDC.inlive mobile app for personalized match
//               alerts, exclusive features, offline highlights, and the ultimate
//               cricket experience.
//             </p>
//           </div>
//         </div>
...
//             <p className="text-gray-800">
//               Join our growing community of 8,310+ subscribers and experience
