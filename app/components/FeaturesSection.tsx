...
//           {/* Card 1 */}
//           <div className="rounded-2xl bg-blue-100 p-8 border border-blue-200">
//             <div className="w-12 h-12 flex items-center justify-center rounded-full bg-blue-400 text-white mb-6">
//               🎥
//             </div>
...
//               Watch every thrilling moment from Kolhapur District cricket
//               matches with crystal-clear HD streaming quality that puts you
...
//             </h3>
//             <p className="text-gray-700 leading-relaxed">
//               Get instant score updates, comprehensive player statistics,
//               detailed match highlights, and ball-by-ball commentary as the
//               game unfolds.
//             </p>
//           </div>
...
//             </h3>
//             <p className="text-gray-700 leading-relaxed">
//               Experience local cricket passion directly on your screen,
//               whether you're at home, work, or on the go—never miss a
