...
//               Follow every delivery with detailed commentary and live
//               scorecards updated instantly as the action unfolds on the field.
//             </p>
//           </div>
...
//             </h3>
//             <p className="text-gray-700 leading-relaxed">
//               Relive key moments, wickets, boundaries, and game-changing
//               milestones through our visual match timeline that tells the
//               complete story.
//             </p>
//           </div>
...
//             </h3>
//             <p className="text-gray-700 leading-relaxed">
//               Participate in live chat discussions, vote in fan polls, enter
//               prediction contests, and connect with fellow cricket enthusiasts
//               during matches.
//             </p>
//           </div>
//         </div>
...
//             </h3>
//             <p className="text-gray-700 leading-relaxed">
//               Our interactive platform transforms passive watching into active
//               participation. Vote on man of the match, predict the next wicket,
//               share your thoughts in real-time, and compete with other fans for
//               bragging rights.
//             </p>
//           </div>
...
//             </h3>
//             <p className="text-gray-700 leading-relaxed">
//               Experience the game from different perspectives with multiple
//               camera feeds, slow-motion replays, and strategic overhead views
//               that bring professional-level coverage to local cricket.
//             </p>
//           </div>
//         </div>
//       </div>
